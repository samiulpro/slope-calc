...
print("If you have two points of any straight line type \"p\" and if you have an equation of that straight line then type \"e\" if you have an angle of that straight line with the positive X-Axis then type \"a\" .")
a=input("type : ")
